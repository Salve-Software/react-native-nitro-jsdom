...
export function IconZap(props: IconProps): ReactNode {
  return base(<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />, props);
}

export function IconCode(props: IconProps): ReactNode {
  return base(
    <>
...
export function IconSync(props: IconProps): ReactNode {
  return base(
    <>
